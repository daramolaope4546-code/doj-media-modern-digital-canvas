...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "DOJ MEDIA" },
      { name: "theme-color", content: "#800020" },
      { name: "apple-mobile-web-app-title", content: "DOJ MEDIA" },
      { name: "application-name", content: "DOJ MEDIA" },
      { property: "og:site_name", content: "DOJ MEDIA" },
      ...
      { name: "twitter:title", content: "DOJ MEDIA | Creative Digital Solutions" },
      { name: "twitter:description", content: "Professional graphic design, web design, video editing, motion design, live streaming and digital creative solutions by DOJ MEDIA." },
    ],
    links: [
      {
        rel: "stylesheet",
